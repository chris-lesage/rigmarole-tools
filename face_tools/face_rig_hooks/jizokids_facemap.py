poseattributes = [
    ...
    'left_brow_angry_CS',
    'left_brow_sad_CS',
    'left_brow_up_angry_CS',
    'left_brow_up_sad_CS',
    'left_brow_down_angry_CS',
    'left_brow_down_sad_CS',
    'right_brow_up_CS',
    'right_brow_down_CS',
    'right_brow_angry_CS',
    'right_brow_sad_CS',
    'right_brow_up_angry_CS',
    'right_brow_up_sad_CS',
    'right_brow_down_angry_CS',
    'right_brow_down_sad_CS',
    'right_smile_CS',
    'left_smile_CS',
    'right_wide_smile_CS',
    'left_wide_smile_CS',
    'left_crow_wrinkle_CS',
    'right_crow_wrinkle_CS',
    'forehead_wrinkle_CS',
    'brow_squeeze_wrinkle_CS',
    'bunny_wrinkle_CS',
    ]
...
faceposes = [
 ...
 # LEFT EYEBROWS (8 poses)
 {'zone': 'brow',    'pose': 'left_brow_down',             'driver': 'Brow_L_ctrl.ty',    'mapping': [0, -1, 0, 1],   'overrides': ['Brow_L_ctrl.tx', 'Brow_L_ctrl.tx'],    'overridemaps': [[0, -1, 0, 1], [0, 1, 0, 1]] },
 {'zone': 'brow',    'pose': 'left_brow_sad',              'driver': 'Brow_L_ctrl.tx',    'mapping': [0, -1, 0, 1],   'overrides': ['Brow_L_ctrl.ty', 'Brow_L_ctrl.ty'],    'overridemaps': [[0, -1, 0, 1], [0, 1, 0, 1]] },
 {'zone': 'brow',    'pose': 'left_brow_up',               'driver': 'Brow_L_ctrl.ty',    'mapping': [0, 1, 0, 1],    'overrides': ['Brow_L_ctrl.tx', 'Brow_L_ctrl.tx'],    'overridemaps': [[0, -1, 0, 1], [0, 1, 0, 1]] },
 {'zone': 'brow',    'pose': 'left_brow_angry',            'driver': 'Brow_L_ctrl.tx',    'mapping': [0, 1, 0, 1],    'overrides': ['Brow_L_ctrl.ty', 'Brow_L_ctrl.ty'],    'overridemaps': [[0, -1, 0, 1], [0, 1, 0, 1]] },
# LEFT EYEBROWS CORRECTIVES 
 {'zone': 'brow',    'pose': 'left_brow_sad_down',         'driver': 'Brow_L_ctrl.ty',    'mapping': [0, -1, 0, 1],   'overrides': ['Brow_L_ctrl.tx'],    'overridemaps': [[ -1, 0, 0, 1 ]] },
 {'zone': 'brow',    'pose': 'left_brow_sad_up',           'driver': 'Brow_L_ctrl.ty',    'mapping': [0, 1, 0, 1],    'overrides': ['Brow_L_ctrl.tx'],    'overridemaps': [[ -1, 0, 0, 1 ]] },
 {'zone': 'brow',    'pose': 'left_brow_angry_up',         'driver': 'Brow_L_ctrl.ty',    'mapping': [0, 1, 0, 1],    'overrides': ['Brow_L_ctrl.tx'],    'overridemaps': [[ 1, 0, 0, 1 ]] },
 {'zone': 'brow',    'pose': 'left_brow_angry_down',       'driver': 'Brow_L_ctrl.ty',    'mapping': [0, -1, 0, 1],   'overrides': ['Brow_L_ctrl.tx'],    'overridemaps': [[ 1, 0, 0, 1 ]] },
 # RIGHT EYEBROWS (8 poses)
 {'zone': 'brow',    'pose': 'right_brow_down',            'driver': 'Brow_R_ctrl.ty',    'mapping': [0, -1, 0, 1],   'overrides': ['Brow_R_ctrl.tx', 'Brow_R_ctrl.tx'],    'overridemaps': [[0, -1, 0, 1], [0, 1, 0, 1]] },
 {'zone': 'brow',    'pose': 'right_brow_sad',             'driver': 'Brow_R_ctrl.tx',    'mapping': [0, 1, 0, 1],   'overrides': ['Brow_R_ctrl.ty', 'Brow_R_ctrl.ty'],    'overridemaps': [[0, -1, 0, 1], [0, 1, 0, 1]] },
 {'zone': 'brow',    'pose': 'right_brow_up',              'driver': 'Brow_R_ctrl.ty',    'mapping': [0, 1, 0, 1],    'overrides': ['Brow_R_ctrl.tx', 'Brow_R_ctrl.tx'],    'overridemaps': [[0, -1, 0, 1], [0, 1, 0, 1]] },
 {'zone': 'brow',    'pose': 'right_brow_angry',           'driver': 'Brow_R_ctrl.tx',    'mapping': [0, -1, 0, 1],    'overrides': ['Brow_R_ctrl.ty', 'Brow_R_ctrl.ty'],    'overridemaps': [[0, -1, 0, 1], [0, 1, 0, 1]] },
# RIGHT EYEBROWS CORRECTIVES 
 {'zone': 'brow',    'pose': 'right_brow_sad_down',        'driver': 'Brow_R_ctrl.ty',    'mapping': [0, -1, 0, 1],   'overrides': ['Brow_R_ctrl.tx'],    'overridemaps': [[ 1, 0, 0, 1 ]] },
 {'zone': 'brow',    'pose': 'right_brow_sad_up',          'driver': 'Brow_R_ctrl.ty',    'mapping': [0, 1, 0, 1],    'overrides': ['Brow_R_ctrl.tx'],    'overridemaps': [[ 1, 0, 0, 1 ]] },
 {'zone': 'brow',    'pose': 'right_brow_angry_up',        'driver': 'Brow_R_ctrl.ty',    'mapping': [0, 1, 0, 1],    'overrides': ['Brow_R_ctrl.tx'],    'overridemaps': [[ -1, 0, 0, 1 ]] },
 {'zone': 'brow',    'pose': 'right_brow_angry_down',      'driver': 'Brow_R_ctrl.ty',    'mapping': [0, -1, 0, 1],   'overrides': ['Brow_R_ctrl.tx'],    'overridemaps': [[ -1, 0, 0, 1 ]] },
 ...
 {'zone': 'eye',    'pose': 'left_eyelid_line',            'driver': 'Eye_L_ctrl.eyelid_line',    'mapping': [-10, 10, -1, 1],    'overrides': [],    'overridemaps': [] },
 {'zone': 'eye',    'pose': 'right_eyelid_line',           'driver': 'Eye_R_ctrl.eyelid_line',    'mapping': [-10, 10, -1, 1],    'overrides': [],    'overridemaps': [] },
